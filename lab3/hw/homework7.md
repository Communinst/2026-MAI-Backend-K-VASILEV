...
## Используя DRF, написать классы-views
...
Моделей может быть много (фильмы и жанры, например), нужно для каждой модели написать такие классы и не забыть добавить их в urls.py. Нужно уметь продемонстрировать работу каждого из методов с помощью клиента (например [Postman](https://www.postman.com/) или консольного клиента (curl, wget и т.д.)).